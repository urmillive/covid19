...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        ...
        <ul class="navbar-nav ml-auto ml-md-0">
            ...
            ?>
                <li class="nav-item">
                    <a class="nav-link" href="index.php">Welcome, <?php echo $_SESSION["admin_username"]; ?></a>
                </li>
                <button class="btn btn-outline-success ml-3 pr-3 pl-3" type="submit" onclick="location.href='admin-logout.php'">Logout</button>
            <?php
            } else {
            ?>
        </ul>
