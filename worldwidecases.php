...
<head>
    ...
    <title>Covid-19 Live Cases</title>
</head>
<body>
    <div class="container-fluid bg-dark text-white p-5 text-center my-3">
        <h1 class="">Covid-19 Live Cases</h1>
    ...
    <footer class="footer mt-auto py-3 bg-light">
        <div class="container text-center">
            <span class="text-muted">Copyright &copy;2020, <a href="https://urmil8989.online" target="_blank">Urmil Rupareliya</a></span>
        </div>
    </footer>
