    ...
    <div class="row">
        <div class="col-md-12">
            <div class="jumbotron my-4 text-center bg-dark text-white">
                <h1 class="display-4 head-text head-text">The Economic Times Blog</h1>
            ...
            <div class="jumbotron my-4 text-center">
                <h1 class="display-4 head-text">The Times of India Blog</h1>
            ...
            <div class="jumbotron my-4 text-center bg-primary">
                <h1 class="display-4 head-text">Geospatial world Blogs</h1>
                <hr class="my-4 bg-dark">
            ...
            <div class="jumbotron my-4 text-center bg-danger">
                <h1 class="display-4 head-text">My Gov. India Blogs</h1>
...
Cases of Covid-19 first emerged in late 2019, when a mysterious illness was reported in Wuhan, China. The cause of the disease was soon confirmed as a new kind of coronavirus, and the infection has since spread to many countries around the world and become a pandemic.</p>
            ...
            <div class="jumbotron my-4 text-center bg-success">
                <h1 class="display-4 head-text">World Bank Blogs</h1>
                <hr class="my-4 bg-white">
            ...
            <div class="jumbotron my-4 text-center bg-warning">
                <h1 class="display-4 head-text">IMF Covid-19  Blogs</h1>
                <hr class="my-4 bg-dark">
